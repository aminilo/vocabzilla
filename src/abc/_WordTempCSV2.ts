...
const rows = [
	...
	['invite', 'He wants to invite his friends to a party.'],
	...
	['love', 'She loved her children and was doing anything to support them.'],
	...
	['travel', 'The sound of the music travelled through the wall.'],
	...
	['create', 'They were trying to create a snowman.'],
	...
	['laugh', 'The teacher got angry seeing them laughing at the new kid.'],
	...
	['loud', 'It\'s important to speak out loud while practicing speaking skills.'],
	['nervous', 'He was nervous around girls.'],
	['nervous', 'She started to feel nervous about her first day at work.'],
	['nervous', 'Don\'t get nervous; it\'s just a test about what you\'ve leaned, and you\'ll be relieved when it\'s over.'],
	...
	['noise', 'The background noise disturbed him trying to focus on the project.'],
	...
	['worse', 'Take her to the doctor if her condition got worse.'],
	...
	['cloud', 'Soon, dark clouds took over the region.'],
	['cloud', 'The entire area became gloomy when the sky clouded over.'],
	['describe', 'She describe to the police how the accident happened.'],
	...
	['instruct', 'She was trying to instruct the kids, but they woudln\'t pay attention.'],
	...
	['apart', 'When I took the cookie, it fell apart because of having cracks in it.'],
	...
	['participant', 'As a participant in the survey, she was asked to answer some questions about her lifestyle.'],
	...
	['vague', 'There was a vague thing in the distance, and they weren\'t sure if it was a human.'],
	...
	['difference', 'Do they have any major difference in quality?'],
	...
	['protect', 'Luckily, there was a police officer that protected the kids.'],
	...
	['therefore', 'He didn\'t know how to fix the deck and, therefore, asked a handyman to do it for him.'],
	...
	['encourage', 'She always encourages her children to study and chase their dreams.'],
	...
	['command', 'The emperor had command over three countries.'],
	...
	['open', 'Open up, it\'s me, Joe.'],
	['open', 'The door of the room opens into a beautiful patio.'],
	['open', 'They opened a bottle of wine and began to talk about their lives.'],
	...
	['service', 'He\'d committed a crime and had to do community service for a few months.'],
	...
	['immediate', 'The venom makes an immediate effect on the victim.'],
	...
	['remain', 'We should remain to be focused on this.'],
	...
	['never', 'Never ever judge people when you\'re not in their shoes.'],
	...
	['attitude', 'Their attitude hardened, but luckily, it was just a misunderstanding, and their attitude softened.'],
	...
	['beauty', 'We love the natural beauty of their village.'],
	...
	['loan', 'She applied for a loan so that she could buy an aparment.'],
	...
	['salary', 'He wouldn\'t take a drop in salary, so he changed jobs.'],
	...
	['local', 'Most of the local residents grew their own crops.'],
	...
	['outline', 'Before writing his novel, he thought about the outline.'],
	...
	['print', 'The content was awesome, but the print quality of the book wasn\'t so good.'],
	...
	['extremely', 'She was extremely excited about it.'],
	...
	['happen', 'It just happened that I knew how to solve their issue.'],
	...
	['opportunity', 'She had a golden opportunity to work for the corporation.'],
	...
	['wonder', 'She was wondering where he was going.'],
	...
	['yet', 'It\'s raining cats and dogs out there, so we can\'t go out yet.'],
	...
	['wear', 'The performer had worn some jewels and rings.'],
	...
	['lone', 'There was just a lone wolf in the entire area.'],
	...
	['solution', 'After a while, he managed to come up with a reasonable solution.'],
	...
	['ask', 'He kept asking questions about the issue.'],
	['ask', 'It\'s appropriate to ask for permission first.'],
	['ask', 'She asked him to move the table.'],
	['ask', 'His friend called him and asked for some money.'],
	...
	['bother', 'He was such a slacker that he didn\'t bother writing his essay.'],
	...
	['brain', 'He was acting as if he was the brains of the group.'],
	...
	['various', 'He wanted to help, though he had various problems on his own.'],
	...
	['contact', 'If the chemical contacts your skin, you should wash it carefully.'],
	['contact', 'Please contanct me at this number if you need any help.'],
	...
	['set', 'He made some inadvertent mistakes, but his teacher was kind enough to give him a chance to set it right.'],
	['set', 'An arson is someone who deliberately sets things on fire.'],
	['set', 'There was a set of dices on the board.'],
	...
	['sound', 'The sound of the music travelled through the neighborhood.'],
	...
	['block', 'Every day, he would go jogging around the block.'],
	['block', 'A terrible accident happened and block the highway.'],
	...
	['feature', 'One feature of this smart phone is the lens used in its camera.'],
	...
	['tip', 'She searched the Internet to get some useful tips about language learning.'],
	...
	['attention', 'The teacher told them to give him their undevided attention.'],
	...
	['attention', 'He was in condition to stay alone and needed medical attention.'],
	...
	['maintain', 'He maintains that he dind\'t know about their plan.'],
	...
	['deal', 'Finally, she managed to strike a deal on the project.'],
	['deal', 'They made a good deal of money selling their crafts.'],
	['deal', 'He wanted to deal with them, but he had no idea how.'],
	...
	['puzzle', 'She was so clever she spent her spare time doing crossword puzzles.'],
	...
	['barely', 'I\'m not fluent in Mandarin yet; I barely know just about a thousand characters.'],
	...
	['driveway', 'A minivan was parked in the driveway, so he couldn\'t move his car.'],
	...
	['message', 'She eloped and left a message saying that she was going to get married.'],
	...
	['message', 'They tried to get the message across that she was taking advantage of him.'],
	...
	['schedule', 'Since he had done all his stuff, he decided to run ahead of schedule and go for the project.'],
	...
	['share', 'We share the same taste in music.'],
	['share', 'You can always share your thoughts with me.'],
	['stage', 'He went to the stage to receive his award.'],
	['stage', 'The band went on stage to perform their album.'],
	...
	['stage', 'He was down in the dumps, but it was just a stage that he was going through.'],
	['stage', 'They wanted to stage the show in an outdoor venue.'],
	['storm', 'Some trees were blown down during the storm.'],
	...
	['within', 'They put more officers around the town to make sure people acted within the law.'],
	...
	['meeting', 'They had a meeting about the latest deal made with a firm.'],
	...
	['above', 'The fox looked above and saw a crow on the tree limb.'],
	...
	['master', 'He said mastering one technique is better than knowing about ten techniques.'],
	...
	['sale', 'Everything for sale there was under 10 dollars.'],
	...
	['east', 'Florida is located in the east coast of America.'],
	...
	['expensive', 'She has expensive tastes for clothing and accessories.'],
	...
	['place', 'Hospital is a place where sick or injured people go to recive medical treatment.'],
	...
	['place', 'He asked his friend to save his place so he could pop out and get some snack.'],
	...
	['such', 'It was such a small room that he couldn\'t stay for long.'],
	...
	['total', 'A total of 23 participants attended the lecture.'],
	...
	['town', 'It was one of the best apartments in town.'],
	...
	['anxious', 'He was anxious that his presentation would impress his colleagues.'],
	...
	['desire', 'They got itchy feet and wanted to satisfy their desire for travelling.'],
	...
	['laughter', 'There was a shrill laughter coming from next door.'],
	...
	['disaster', 'Four cars crashed into each other; it was a disaster.'],
	...
	['disturb', 'We are disturbing the ecological balance by our selfish actions.'],
	...
	['honor', 'They named the child after him in honor of his grandfather.'],
	...
	['proceed', 'They had to proceed along the rugged terrain despite difficulty.'],
	...
	['clear', 'He realized if he fix the issue, he could have a clear conscience again.'],
	...
	['volcano', 'It was a dormant volcano, but they weren\'t sure when it would erupt.'],
	...
	['against', 'The two friends leaned against the wall.'],
	...
	['ocean', 'They sailed on the ocean with a boat.'],
	...
	['citizen', 'Despite their hard work, very immigrants were treated like secon-class citizens.'],
	...
	['enormous', 'An enormous amount of money was needed for such project.'],
	...
	['trap', 'They fall into the enemy\'s trap, surrounded by dozens of them.'],
	...
	['convert', 'Do you know the formula to convert Mile into Kilometer?'],
	...
	['billion', 'India has over one billion population.'],
	['billion', 'They invested billions of dollars on the project.'],
	...
	['potential', 'His coach helped him reach his full potential.'],
	...
	['talent', 'He had a talent for playing football.'],
	...
	['foundation', 'It took several weeks just to lay the foundations of the structure.'],
	['foundation', 'The course is meant to give a solid foundation of basic programming concepts.'],
	['generation', 'They were from different generations.'],
	['generation', 'It was a tradition that had been in his family for generations.'],
	...
	['pound', 'Someone was pouding on the door.'],
	['pound', 'The shed was pounded to pieces after the earthquake.'],
	...
	['bet', 'She bet him ten dollars that she would finish her work faster.'],
	...
	['differ', 'His story differed from the one she said.'],
	...
	['labor', 'She was in intense pain while going into labor.'],
	...
	['shift', 'His attitude toward digital currencies shifted when he realized its potentials.'],
	...
	['ability', 'His fighting abilities helped him survive.'],
	['ability', 'She was born with an innate ability to do math.'],
	['ability', 'He had the ability to craft a weapon quickly.'],
	['ability', 'She had the ability to explain complex ideas clearly.'],
	...
	['curious', 'When he put on the Vision Pro, most people had curious looks on their faces.'],
	...
	['duty', 'Since she was off duty, she could enjoyed hanging out with her friends.'],
	...
	['insert', 'He inserted the key into the lock to unlocked the door.'],
	...
	['rank', 'His rank in the firm was lower than him.'],
	...
	['refrigerate', 'She refrigerated the dairy products she had bought.'],
	...
	['astronaut', 'He always liked space and wanted to become an astronaut.'],
	...
	['courage', 'He plucked up the courage and went to look around for his friend.'],
	...
	['miner', 'The miner found several jewels and pieces of diamond.'],
	...
	['permission', 'The permission to build a parking lot was granted.'],
	['permission', 'A thief is someone who takes people\'s properties without permission.'],
	...
	['scale', 'He wasn\'t awake to the scale of the problem.'],
	...
	['alarm', 'Their sudden movement caused alarm to the deer and it vanished.'],
	['alarm', 'They didn\'t want to alarm him, so they pretended they still had the ring.'],
	['arrest', 'The police arrested her for possession of illegal drug.'],
	...
	['award', 'They gave her an award for getting the highest grades in her class.'],
	...
	['breed', 'Most animals breed in certain seasons to ensure a good condition for their babies.'],
	...
	['contest', 'She entered the contest just for fun, yet she won.'],
	...
	['card', 'Most customers pay their bills with debit cards.'],
	...
	['value', 'They bought something at the market that was of a good value.'],
	...
	['star', 'There are millions of stars in outer space.'],
	...
	['adjust', 'They had difficulty adjusting to living with an alien society.'],
	...
	['firm', 'They wanted to make sure if the planks were firm enough.'],
	...
	['plain', 'He tried to make it plain so that the students could understand the subject.'],
	['reef', 'The ship hit a coral reef and was stuck.'],
	...
	['minister', 'The minister was baptizingk the newborn baby.'],
	...
	['breath', 'He paused for a few seconds to catch his breath, then continued running.'],
	['breath', 'Whenever you\'re nervous, try taking a deep breath and empty your mind for a few seconds.'],
	...
	['seed', 'After a while, the seeds started to sproute.'],
	['sharp', 'Her pen wasn\'t sharp enough, so she used a sharpener.'],
	...
	['deserve', 'He had been training hard, and now he deserved to win.'],
	...
	['intelligence', 'Due to his high intelligence, he learned the job very fast.'],
	...
	['iron', 'The blacksmith used iron to make a shield.'],
	...
	['occupy', 'All the gazebos were occupied in the park.'],
	...
	['persist', 'He couldn\'t understand the concept, but he persisted until he learn it.'],
	...
	['sensation', 'After the tranquilizer, he had no sensation of pain.'],
	...
	['publication', 'Her latest book gained popularity shorly after its publication.'],
	...
	['spoil', 'He didn\'t want to eat junk food, trying not to spoil his appetite.'],
	['spoil', 'She spoiled the movie for him by telling what happened.'],
	...
	['broadcast', 'The final match was broadcasted live to all provinces.'],
	['broadcast', 'After only a few days, their affair was broadcasted to the entire town.'],
	...
	['rear', 'The mother wolf reared its young until it got strong.'],
	...
	['abandon', 'While trying to kick the habit of masturbation, you must not abandon yourself to sudden impulses.'],
	...
	['ambitious', 'Building such a tremendous structure was an ambitious plan.'],
	['bark', 'A dog had been barking for a few minutes before somebody called out for help.'],
	['bark', 'He woke up because of a dog\'s bark.'],
	...
	['expedition', 'The astronauts were all enthusiastic about their expedition to the Mars.'],
	...
	['restore', 'I\'ve got a cold, and I really hope I\'ll restore to health quickly.'],
	['rub', 'He rubbed at the stain and tried to wipe it out.'],
	...
	['fabric', 'Her dress was made from a silk fabric.'],
	['fabric', 'Trust and mutual respect form the fabric of healthy relationships.'],
	...
	['quarrel', 'Finally, they patched up their quarrel and became reconciled.'],
	...
	['strain', 'He\'d been under a lot of strain because of his problems.'],
	...
	['absence', 'In his father\'s absence, he had learned a lot.'],
	...
	['nap', 'He was so tired he took a nap at his office.'],
	...
	['suck', 'She gave the baby a bottle of milk to suck.'],
	['urgent', 'During the famine, hundreds of people were in urgent need for food.'],
	...
	['bloom', 'Most plants had came into bloom.'],
	...
	['beam', 'Suddenly, a beam of light shone into their eyes.'],
	...
	['dissolve', 'She dissolved two spoonful of sugar in some warm milk.'],
	...
	['sensible', 'Moving to a place within walking distance to his workplace was a sensible thing to do.'],
	...
	['shallow', 'He showed how shallow he is by his ridiculous comment.'],
	...
	['boom', 'Their business boomed shortly after the new scheme.'],
	...
	['thunder', 'Shortly after a clap thunder boomed, it began raining.'],
	['troop', 'They retreated as more ground troops entered the area.'],
	['troop', 'Troops were deployed in the area, waiting for orders.'],
	...
	['ease', 'The doctor gave him tranquilizer to ease his pain.'],
	...
	['gender', 'He didn\'t want to know the gender of his baby.'],
	...
	['desperate', 'They were in desperate need for help.'],
	...
	['gather', 'They gathered money together and bought him a present.'],
	...
	['nuclear', 'There were some nuclear power plants.'],
...
fs.writeFileSync(path.join(__dirname, 'word_temp.csv'), csvLines.join('\n'));
